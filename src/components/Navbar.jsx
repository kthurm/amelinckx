      ...
      <div className="bg-[#FAF6EB] fixed w-full shadow-xl py-2 z-50">
        <div className="max-w-screen-xl mx-auto relative flex justify-between lg:items-center py-1.5 px-5 sm:px-10">
          ...
          <nav
            ...
            className={
              navbarOpen
                ? "absolute lg:relative right-0 top-[3.3rem] lg:top-0 bg-[#FAF6EB] shadow-lg lg:shadow-none transition transform duration-500 opacity-100 translate-x-0"
                : "opacity-0 right-0 absolute lg:relative top-[3.3rem] lg:top-0 bg-[#FAF6EB] shadow-lg lg:shadow-none translate-x-full h-0 lg:opacity-100 lg:translate-x-0 lg:h-full duration-500"
            }
          >
