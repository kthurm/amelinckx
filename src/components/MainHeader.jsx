  ...
  return (
    <div>
      <header className="fixed w-full flex justified-between h-[450px] lg:overflow-hidden z-10">
        <div
          className="flex w-1/2 md:w-2/3 relative bg-cover bg-black/50 bg-blend-darken bg-right-top lg:bg-left-top"
          style={{ backgroundImage: `url('${Syncom}')` }}
        ></div>
        <div
          className="relative w-1/2 md:w-1/3 bg-cover bg-no-repeat bg-left-top"
